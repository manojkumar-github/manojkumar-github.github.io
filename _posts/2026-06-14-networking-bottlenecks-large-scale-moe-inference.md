...
image: /assets/img/moe-architecture.svg
tags: [MoE, inference, NVIDIA, NCCL, InfiniBand, NVLink, networking, GPU, distributed-systems]
---
...
![Request lifecycle across the inference platform]({{ '/assets/img/moe-architecture.svg' | relative_url }})
...
![Throughput vs GPU count, ideal versus measured]({{ '/assets/img/moe-scaling.svg' | relative_url }})
...
![Per-token MoE communication flow with two all-to-all collectives]({{ '/assets/img/moe-comm-flow.svg' | relative_url }})
...
![Incast onto a hot expert overloading a switch port]({{ '/assets/img/moe-incast.svg' | relative_url }})
...
![Flat versus hierarchical all-to-all]({{ '/assets/img/moe-hierarchical-a2a.svg' | relative_url }})
...
![Rail-optimized spine-leaf topology with NVLink islands]({{ '/assets/img/moe-rail-topology.svg' | relative_url }})
