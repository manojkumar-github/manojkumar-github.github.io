---
title: "Benchmarking LLMs at Scale: Architecting a Reproducible, GPU-Efficient Platform for Hundreds of Models a Day"
date: 2026-06-20
author: Xariv Infrastructure
category: "AI Infrastructure"
description: "An architecture case study on a platform that benchmarks hundreds of LLMs daily across heterogeneous GPU clusters — why it looks like a massive-scale system but is really a modest-throughput, high-cost, high-fidelity batch system, where the hard problems are reproducibility, clean placement, and GPU efficiency, not QPS."
excerpt_override: "Hundreds of models, thousands of GPUs, a multi-million-dollar compute bill — and yet the scheduler dispatches about once a second. The hard part of benchmarking LLMs at scale isn't throughput. It's trusting the number."
image: /assets/img/bench-architecture.svg
tags: [benchmarking, LLM, GPU, reproducibility, scheduling, distributed-systems, vLLM, performance, AI-infrastructure, scale]
---
...
![The Sweep → Setting → Run → Result data model keyed by setting_hash]({{ '/assets/img/bench-data-model.svg' | relative_url }})
...
![The counterintuitive scale profile of the benchmarking platform]({{ '/assets/img/bench-scale-flip.svg' | relative_url }})
...
![Two-plane architecture with a durable queue as the seam]({{ '/assets/img/bench-architecture.svg' | relative_url }})
...
![The fail-closed runner pipeline with pre-flight verification]({{ '/assets/img/bench-runner.svg' | relative_url }})
...
![Constraint-satisfaction scheduling with locality and fairness]({{ '/assets/img/bench-scheduler.svg' | relative_url }})
...
![Dimensional star schema and the payoff comparison query]({{ '/assets/img/bench-comparison.svg' | relative_url }})
