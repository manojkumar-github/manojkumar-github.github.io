---
title: "Per-User RAG at Scale: Architecting a Private AI Inbox for 220M Users and Billions of Queries a Day"
date: 2026-06-18
author: Xariv Infrastructure
category: "AI Infrastructure"
description: "An architecture case study on building per-user, privacy-isolated Retrieval-Augmented Generation (RAG) for a consumer AI mail assistant at 220M-user scale — why it's write-dominated, why the hosted-LLM bill dominates everything, and how partitioning by user_id solves performance, isolation, cost, and compliance at once."
excerpt_override: "It looks read-heavy. It isn't. A per-user RAG over private mail at 220M-user scale is write-dominated, the LLM bill dwarfs the infrastructure, and one partitioning decision quietly solves four problems at once."
image: /assets/img/rag-architecture.svg
tags: [RAG, retrieval, vector-database, multi-tenant, isolation, Kafka, caching, distributed-systems, AI-inbox, scale]
---
...
![Read vs write throughput and the LLM cost headline]({{ '/assets/img/rag-scale-flip.svg' | relative_url }})
...
![Two-system architecture sharing a user-partitioned storage layer]({{ '/assets/img/rag-architecture.svg' | relative_url }})
...
![Per-user partitioning turns global ANN into a tiny per-user search]({{ '/assets/img/rag-partitioning.svg' | relative_url }})
...
![Hot/cold tiering of per-user indexes and the RAM wall]({{ '/assets/img/rag-tiering.svg' | relative_url }})
...
![Relevance-scoped, event-driven cache invalidation]({{ '/assets/img/rag-cache-invalidation.svg' | relative_url }})
...
![Kafka partition ordering and the ghost-document compliance bug]({{ '/assets/img/rag-ordering.svg' | relative_url }})
