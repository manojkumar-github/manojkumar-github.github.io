---
title: "Serving Hundreds of LLMs at Scale: Architecting a Multi-Model Inference Platform Across Heterogeneous GPUs"
date: 2026-06-22
author: Xariv Infrastructure
category: "AI Infrastructure"
description: "An architecture case study on a multi-tenant LLM inference platform serving hundreds of models across heterogeneous GPUs (H100, A100, RTX Pro 6000, L40S, L4) — the throughput-latency-cost triangle, KV-cache as the binding constraint, continuous batching and PagedAttention, prefill/decode disaggregation, and mapping each workload to the cheapest GPU that hits its SLO."
excerpt_override: "Hundreds of models, ten thousand GPUs, a nine-figure compute bill — and almost every design decision turns out to be one dial: how much do you pay, in money or complexity, to protect latency? Here's the platform that runs the models."
image: /assets/img/inf-architecture.svg
tags: [LLM, inference, GPU, vLLM, KV-cache, continuous-batching, PagedAttention, scheduling, heterogeneous-GPU, AI-infrastructure, scale]
---
...
![Prefill vs decode: two phases that fight on a shared GPU, and the two fixes]({{ '/assets/img/inf-prefill-decode.svg' | relative_url }})
...
![Scale estimation: tokens not requests, GPU count, cost, and the KV binding constraint]({{ '/assets/img/inf-scale-numbers.svg' | relative_url }})
...
![Two-plane inference platform architecture]({{ '/assets/img/inf-architecture.svg' | relative_url }})
...
![Continuous batching, the KV cache, and PagedAttention]({{ '/assets/img/inf-kv-batching.svg' | relative_url }})
...
![Mapping models and phases to a heterogeneous GPU fleet]({{ '/assets/img/inf-gpu-fleet.svg' | relative_url }})
...
![Load/cache-aware routing, priority queues, and graceful saturation]({{ '/assets/img/inf-router.svg' | relative_url }})
