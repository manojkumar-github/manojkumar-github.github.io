---
title: "Kernel Fusion for Large-Scale LLM Inference: When GPU Memory Bandwidth, Not Compute, Is the Bottleneck"
date: 2026-06-16
author: Xariv Infrastructure
category: "AI Infrastructure"
description: "An architecture case study on serving a 32B LLM for AI search answer generation at billions of requests per day — why a single H100 sat memory-bound, and how kernel fusion with TensorRT-LLM and vLLM raised throughput ~1.7× without touching model quality."
excerpt_override: "A single H100, a 32B model, billions of short answers a day — and GPUs that looked busy but weren't fast. The bottleneck wasn't compute. It was memory bandwidth, and the fix was kernel fusion."
image: /assets/img/kf-architecture.svg
tags: [LLM, inference, kernel-fusion, GPU, NVIDIA, TensorRT-LLM, vLLM, FlashAttention, memory-bandwidth, AI-search]
---
...
![Single-GPU serving stack for short-form answer generation]({{ '/assets/img/kf-architecture.svg' | relative_url }})
...
![Unfused pipeline round-tripping HBM between every stage]({{ '/assets/img/kf-memory-traffic.svg' | relative_url }})
...
![Roofline placing decode in the memory-bound region]({{ '/assets/img/kf-roofline.svg' | relative_url }})
...
![Before and after fusion, with timeline compaction]({{ '/assets/img/kf-fusion.svg' | relative_url }})
...
![Before/after results bar chart]({{ '/assets/img/kf-results.svg' | relative_url }})
